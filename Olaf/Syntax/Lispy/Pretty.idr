module Olaf.Syntax.Lispy.Pretty
...
olaf (MatchList what empty extend)
  = parens (pretty "match" <++> (align $ vsep [ olaf what
                                              , brackets (olaf empty)
                                              , brackets (olaf extend)]))

olaf (Pair l r)
  = parens (hsep [olaf l <+> comma, olaf r])

olaf (MatchPair pair cases)
  = parens (pretty "match" <++> (align $ vsep [ olaf pair
                                              , brackets (olaf cases)]))
...
olaf (MatchSum what this that)
  = parens (pretty "match" <++> (align $ vsep [olaf what, brackets (olaf this), brackets (olaf that)]))
